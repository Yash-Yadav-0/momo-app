  ...
  return (
    <div className="testimonials">
      <div className="testimonials_slider">
        <div>
          <p className="big-text-two">
            200+{" "}
            <span style={{ color: "var(--primary)" }}>Happy Costomers</span>
          </p>
          <p className="big-text-three " style={{ color: "var(--secondary)" }}>
        ...
        <div className="quotes">
          {Quotes.map((item, index) => (
            <div key={index}>
              ...
              <div style={{ fontSize: "31px", marginTop: 21 }}>{item.Name}</div>
            </div>
          ))}
          <div className="slider-button">
            <button className="arrow-button">
              <svg
                ...
                <path
                  d="M12.6668 8L3.3335 8M3.3335 8L7.3335 12M3.3335 8L7.3335 4"
                  stroke="#252D43"
                  stroke-width="2"
